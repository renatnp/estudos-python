...
# Exemplo: converter string para inteiro
idade_string = "20"          # id: tipo string
idade = int(idade_string)    # Convertendo string para int


# 4. Entrada com input() - Recebe dados do usuário.
# input() retorna um valor como string, então convertemos para o tipo desejado.
...
# Exibindo os dados recebidos com uma f-string (uma forma de incluir variáveis dentro de strings)
